...
- Механика подтверждена по загрузчику типов FS22 (движок общий с FS25; открытого зеркала загрузчика
  FS25 нет). Базовые типы (`cutter`, `mower`, …) заданы в данных игры.
