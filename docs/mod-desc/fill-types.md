...
- Механика подтверждена по исходникам FS22 и FS25 (`FillTypeManager.lua`, `FillUnit.lua`, `mods.lua`) и
  реальными модами (FS25_CropDiseases_BMP, FS25_morePalletsCapacity, TargetFillLevel). Полный базовый
