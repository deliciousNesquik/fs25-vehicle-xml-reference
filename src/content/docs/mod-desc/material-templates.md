---
title: "Элемент <materialTemplates>"
description: "Шаблоны материалов/цветов магазина (FS25): colorScale sRGB + PBR, наследование parentTemplate."
sidebar:
  label: "materialTemplates"
---
```xml
<materialTemplates>
