---
title: "Элемент <densityMapHeightTypes>"
description: "Типы насыпных материалов (кучи на земле); внешний файл, привязка к fillType; условие высыпания."
sidebar:
  label: "densityMapHeightTypes"
---
```xml
