---
title: "Кастомная покраска через спецификацию (скрипт)"
description: "Спека для рантайм-покраски: параметр colorScale, сохранение, MP, полный исходник."
sidebar:
  label: "Кастомная покраска"
---
