---
title: "Элемент <baseColorConfigurations>"
description: "Выбор основного цвета в магазине: <baseColorConfiguration> (шаблон/RGB) + подписка <material materialSlotName>."
sidebar:
  label: "baseColorConfigurations"
---
```xml
