---
title: "Материалы и покраска: шаблоны материалов"
description: "Шаблоны материалов (colorScale sRGB + PBR), применение по materialSlotName, типы конфигураций цвета."
sidebar:
  label: "Материалы и покраска"
---
```xml
